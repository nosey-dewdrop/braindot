...
- NAME LOCKED (19 Jul, Damla): **braindot**. Name history: nymphee (dropped 18 Jul, bad
  connotation: nympho / femme-fatale / Lilith) → inkbee (18 Jul) → braindot (19 Jul; the
  inkbee name was reassigned to the YKS app). Domain = subdomain under noseydewdrop.com
  (braindot.noseydewdrop.com). Trademark classes to clear when going public: SaaS/branding
  (42/35); indie can start on name+subdomain, register at traction.
...
- (name search closed 19 Jul: braindot)
